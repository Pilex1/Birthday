...
public abstract class Entity {
	...
	public abstract void onRender(PVector camera);
	...
	public ArrayList<Platform> getPlatformsStandingOn() {
		...
		ArrayList<Platform> colliding = Main.Processing.manager.getCollidingPlatforms(this);
	...
	private void jumpDy(float dy) {
		...
		ArrayList<Platform> collidingNotSolid = Main.Processing.manager.getCollidingNotSolidPlatforms(this);
	...
	private void moveRightDx(float dx) {
		...
		ArrayList<Platform> collidingNotSolid = Processing.manager.getCollidingNotSolidPlatforms(this);
		for (Platform p : collidingNotSolid) {
